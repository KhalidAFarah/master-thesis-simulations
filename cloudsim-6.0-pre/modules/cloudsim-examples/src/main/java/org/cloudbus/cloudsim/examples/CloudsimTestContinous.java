...
public class CloudsimTestContinous {

    private static List<Cloudlet> cloudlets;
    private static List<Vm> VMs;
    private static List<HostDynamicWorkload> hosts;
    ...
    private static List<Cloudlet> createCloudlet(int userId, int cloudlets, int idShift){
        ...
        //cloudlet parameters
        long length = 40000 * 1000;
        long fileSize = 300 * 1000;
        long outputSize = 300 * 1000;
        int pesNumber = 1;
    ...
    private static Datacenter createDatacenter(String name){
        ...
        int bw = 10000;
        HostDynamicWorkload host = new HostDynamicWorkload(
                hostId,
    ...
    private static void printHostStates(List<HostDynamicWorkload> list) {
        Log.printLine();

        for (HostDynamicWorkload host : list) {
            Log.printLine("host ID: " + host.getId());
            for (HostStateHistoryEntry entry : host.getStateHistory()){
                Log.printLine(entry.getTime() + " - " + entry.getRequestedMips() + " - " + entry.getAllocatedMips());
            }
    ...
    public static void main(String[] args){
        try{
            ...
            cloudlets = createCloudlet(broker.getId(), 1000, 0); // creating 10 cloudlets
            ...
            Runnable monitor = () -> {
                ...
                while (runMonitorThread.run){
                    try{
                        ...
                        Log.print("Number of completed cloudlets ");
                        Log.print(i);
                        Log.print("/");
                        Log.printLine(cloudlets.size());
                        /*Log.printLine("");
                        Log.printLine("-----------------");
